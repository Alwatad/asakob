...
// Seed data for initial Asakob setup
...
export const seedProducts = [
  {
    ...
    description: 'This is a sample product for your Asakob store.',
...
export const seedGlobals = {
  ...
  footer: {
    ...
    copyright: '© 2024 Asakob. All rights reserved.',
  },
  settings: {
    siteName: 'Asakob',
